...
class _settingsState extends State<settings> {
  ...
  Future<void> assess() async {
    final Uri url = Uri.parse(
        'https://play.google.com/store/apps/details?id=com.quran.app');
  ...
  Future<void> developer() async {
    final Uri url =
        Uri.parse('https://instagram.com/100_w9?utm_medium=copy_link');
    if (!await launchUrl(url)) {
      throw Exception('Could not launch $url');
    }
  }
            ...
            Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    "تطبيق مجاني وغير ربحي (يعمل بدون اتصال بالإنترنت) لئجر وثواب. نسئلكم الدعاء لوالديه",
                    textAlign: TextAlign.right,
                    style: TextStyle(
                        fontFamily: "ar",
                        fontSize: 12,
              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text(
                      "تم تطوير وتصميمه بواسطة المهندس حسين علي البياتي.",
